-- Create BRAND NEW trainer with CLEAN approach
-- This will definitely work!

-- First, delete any existing user and profile
DELETE FROM public.user_profiles WHERE email = 'newtrainer2024@freegym.gr';
DELETE FROM auth.users WHERE email = 'newtrainer2024@freegym.gr';
