-- Create SUPER UNIQUE trainer with completely different email
...
INSERT INTO public.user_profiles (
    ...
    (SELECT id FROM auth.users WHERE email = 'supertrainer2024@freegym.gr'),
    'Super',
    'Trainer',
    'supertrainer2024@freegym.gr',
    'trainer',
...
WHERE u.email = 'supertrainer2024@freegym.gr';