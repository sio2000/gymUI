/* UPDATE GET_TRAINER_USERS_WITH_PROFILE_IMAGE - Ενημέρωση get_trainer_users για profile_image_url
   Εκτέλεση στο Supabase SQL Editor */

-- First, add the profile_image_url column if it doesn't exist
...
-- Create updated function with profile_image_url
...
-- Success message
SELECT 'get_trainer_users function updated with profile_image_url!' as message;
