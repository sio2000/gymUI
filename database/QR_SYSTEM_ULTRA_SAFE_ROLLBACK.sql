-- QR System Rollback Script - ULTRA SAFE VERSION
-- Feature Flag: FEATURE_QR_SYSTEM
-- Version: 1.0.2
-- This script safely removes the QR system without errors
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.routines WHERE routine_name = 'update_updated_at_column') THEN
        ...
        RAISE NOTICE 'update_updated_at_column function dropped';
    END IF;
END $$;
