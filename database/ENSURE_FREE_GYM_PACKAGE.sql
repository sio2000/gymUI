-- ENSURE FREE GYM PACKAGE - Δημιουργία/Ενημέρωση Free Gym package
...
-- 2. Δημιουργία Free Gym package (με default price)
INSERT INTO membership_packages (name, description, price, is_active)
VALUES ('Free Gym', 'Απεριόριστη πρόσβαση στο γυμναστήριο', 0.00, true);
