-- Create UNIQUE trainer with completely new email
...
INSERT INTO public.user_profiles (
    ...
    (SELECT id FROM auth.users WHERE email = 'uniquetrainer2024@freegym.gr'),
    'Unique',
    'Trainer',
    'uniquetrainer2024@freegym.gr',
    'trainer',
...
WHERE u.email = 'uniquetrainer2024@freegym.gr';