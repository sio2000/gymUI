-- Create ULTRA NEW trainer with completely different email
...
INSERT INTO public.user_profiles (
    ...
    (SELECT id FROM auth.users WHERE email = 'ultratrainer2024@freegym.gr'),
    'Ultra',
    'Trainer',
    'ultratrainer2024@freegym.gr',
    'trainer',
...
WHERE u.email = 'ultratrainer2024@freegym.gr';
