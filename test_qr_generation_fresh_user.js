// Script για testing QR code generation με fresh user
...
async function testQRGenerationFreshUser() {
  try {
    console.log('🔧 Testing QR code generation με fresh user...\n');
    
    // Χρησιμοποιώ έναν user που δεν έχει QR codes
    const testUserId = 'e67e3afa-85ed-4019-b474-ed0632dfa44b'; // Test User
